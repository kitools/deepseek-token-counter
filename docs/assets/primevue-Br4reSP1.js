...
`,Pu={root:"p-iconfield"},Tu=P.extend({name:"iconfield",style:xu,classes:Pu}),Eu={name:"BaseIconField",extends:j,style:Tu,provide:function(){return{$pcIconField:this,$parentInstance:this}}},io={name:"IconField",extends:Eu,inheritAttrs:!1};function Au(e,t,n,i,r,o){return f(),g("div",p({class:e.cx("root")},e.ptmi("root")),[w(e.$slots,"default")],16)}io.render=Au;var Du={root:"p-inputicon"},Bu=P.extend({name:"inputicon",classes:Du}),Mu={name:"BaseInputIcon",extends:j,style:Bu,props:{class:null},provide:function(){return{$pcInputIcon:this,$parentInstance:this}}},oo={name:"InputIcon",extends:Mu,inheritAttrs:!1,computed:{containerClass:function(){return[this.cx("root"),this.class]}}};function _u(e,t,n,i,r,o){return f(),g("span",p({class:o.containerClass},e.ptmi("root")),[w(e.$slots,"default")],16)}oo.render=_u;var Fu=({dt:e})=>`
.p-inputtext {
    font-family: inherit;
    font-feature-settings: inherit;
    font-size: 1rem;
